...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            _selectedIndex == 0 ? 'Gym Trainer Prototype' : 'Configuración'),
                    ...
                    if (exercises.isEmpty) {
                      return const Card(
                        child: Padding(
                          ...
                          child:
                              Center(child: Text('No hay ejercicios todavía.')),
                        ),
                      );
                    }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: const [
            ...
            _ChecklistItem(
                text:
                    'Perfil editable y persistido para personalización futura'),
            _ChecklistItem(
                text: 'Estado IA visible desde backend sin exponer secretos'),
          ],
        ),
      ),
    );
